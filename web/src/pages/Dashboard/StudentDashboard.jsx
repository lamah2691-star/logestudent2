...
const StudentDashboard = () => {
  ...
  useEffect(() => {
    const fetchStudentData = async () => {
      try {
        ...
        const { data } = await axios.get(`${API_URL}/dashboard/student`);
  ...
  if (loading) return <div style={{ textAlign: 'center', padding: '5rem' }}>Chargement du dashboard étudiant...</div>;
  if (!studentData) return <div style={{ textAlign: 'center', padding: '5rem' }}>Données non disponibles.</div>;

  const { name, activeStay, activities } = studentData;
        ...
        <section className={styles.grid}>
          ...
          <div className={styles.featuredCard}>
            ...
            <div className={styles.cardImageContainer}>
              <img
                src="https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?auto=format&fit=crop&q=80&w=500"
                alt="Chambre"
          ...
          <div className={styles.activityCard}>
            <div className={styles.cardHeader}>
              <h3 className={styles.cardTitle}>Activités récentes</h3>
